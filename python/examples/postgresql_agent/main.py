...
from composio.tools.local import postgresqltool, filetool
...
tools = toolset.get_tools(apps=[App.POSTGRESQLTOOL, App.FILETOOL])
...
user_description = "The database name is composio"  # Edit the description for your database and tables
